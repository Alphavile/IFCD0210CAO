...
function actividad2(){
    ...
    function cambiar(){
        document.getElementById('matrix').src="matematicas_22cf5007_1200x630.jpg";
      }
      function volver(){
        document.getElementById('matrix').src="SEO1488-thumb.png";
      }
...
document.getElementById("envio").addEventListener("click", actividad11);
